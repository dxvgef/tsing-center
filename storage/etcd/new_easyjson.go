...
func easyjson16d7ec28DecodeLocalStorageEtcd(in *jlexer.Lexer, out *Etcd) {
...
func easyjson16d7ec28EncodeLocalStorageEtcd(out *jwriter.Writer, in Etcd) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Etcd) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson16d7ec28EncodeLocalStorageEtcd(&w, v)
...
func (v *Etcd) UnmarshalJSON(data []byte) error {
	...
	easyjson16d7ec28DecodeLocalStorageEtcd(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Etcd) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson16d7ec28DecodeLocalStorageEtcd(l, v)
}
